...
export default function UserChoosen() {
    return (<div style={{backgroundColor : "#043045", height: "150vh"}}>
        <div className="mb-6">
        ...
        <div className="flex-1 flex items-center justify-around">
                <div className="w-full max-w-7xl relative">
                    <div className="text-center space-y-2 mb-6" style={{ marginBottom : "50px" }} >
                        <h1 className={`text-7xl font-bold text-white ${wixDisplay.className}`}   >Step 2</h1>
                    ...
                    <div className="flex justify-center items-center ">
                        <Link href="/auth/register/choosenUser/doctor">
                            <div className="bg-[#0C9A83] rounded-3xl p-7 border-white border-2 flex flex-col items-center w-[350px] h-[457px] hover:shadow-2xl hover:shadow-black/30 hover:scale-105 transition-transform duration-300 active:bg-[#118675] active:duration-75">
                                ...
                                <div>
                                    ...
                                    <ul className="list-disc">
                                        <li>Documents verifying exitance and legitimacy  of your medical office</li>
                                        <li>Documents including your medical license, medical profile and medical practice history. read <span className="text-blue-300 inline hover:underline hover:cursor-pointer hover:to-blue-200">terms of service</span> </li>
                                    </ul>
                                </div>
                            </div>
                        </Link>
                        ...
                        <div className="flex items-center justify-center ml-25 mr-25">
                            <div className="flex flex-col items-center gap-8">
                                <div style={{ width: '2.5px', height: '168px', borderRadius: '10px', backgroundColor: 'white' }} />
                        ...
                        <Link href="/auth/register/choosenUser/secretary">
                            <div className="bg-[#0C9A83] rounded-3xl p-7 border-white border-2 flex flex-col items-center w-[350px] h-[457px] shadow-md shadow-black/30 hover:shadow-2xl hover:shadow-black/30 hover:scale-105 transition-transform duration-300 active:bg-[#118675]">
                                ...
                                <div>
                                    <ul className="list-disc">
                                        <li>be able to apply for work online on any <span className="font-bold">public</span> medical office.</li>
                                        <li>manage over patients for a medical office.</li>
                                        <li>delegate patients over to a specific doctor in the office</li>
                                    </ul>
                                </div>
                            </div>
                        </Link>
