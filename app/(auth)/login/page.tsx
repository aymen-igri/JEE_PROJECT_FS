...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const roleString = data.role as string;
      let userRole = "";
      if (Array.isArray(data.role)) {
        userRole = data.role[0];
      } else if (typeof data.role === "string") {
        const roleMatch = data.role.match(/ROLE_[A-Z_]+/);
        userRole = roleMatch ? roleMatch[0] : "";
      }
          ...
          >
            ...
            <p className="text-lg text-white/70">
              ...
              <Link href="/auth/register">
                <span className="text-white/90 cursor-pointer hover:underline">
                  sign up
                </span>
              </Link>
            </p>
          ...
          <div className="flex items-center justify-center gap-8 lg:gap-24">
            ...
            <div className="space-y-5 flex-1 max-w-xs">
              ...
              >
                ...
                <span className="text-[#5eb3e8] font-medium text-base font-mono">
